...
//
//  Full credit and attribution to the author (Ramon Torres) for this SmoothGradient code.
//  This was obtained from https://github.com/raymondjavaxx/SmoothGradient,
//  released under the MIT license. License included in the root of this package.
//
...
struct GradientInterpolator {
  ...
  init(curve: UnitCurve, color1: Color, color2: Color) {
    self.curve = curve
